...
main = do
    ...
    spawn "sh /home/marcial/.xmonad/autostart.sh"
...
myManageHook = composeAll
		...
		, className =? "xbmc.bin"	--> doShift "8:vid"
		, className =? "rdesktop"	--> doShift "6:vm"
		, className =? "Wine"	--> doShift "7:games"
		, className =? "Wow.exe" --> doShift "7:games"
		, className =? "Wow-64.exe" --> doShift "7:games"
		, className =? "Battle.net.exe" --> doShift "7:games"
		, className =? "Steam"	--> doShift "7:games"
		, className =? "feh"	--> doShift "9:gimp"
		, className =? "SeamlessRDP"	--> doShift "5:doc"
		, className =? "Mcomix"	--> doShift "5:doc"
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
   ...
   -- Display key
    ...
    , ((0, xF86XK_Display	), spawn "bash /home/marcial/bin/xrandr-laptop")
